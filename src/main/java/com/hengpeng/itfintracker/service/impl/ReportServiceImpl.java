...
import com.hengpeng.itfintracker.commons.utils.DateUtils;
import com.hengpeng.itfintracker.dao.MediaAccessCensusMapper;
	...
	public List<MediaTypeReportDto> getDailyMediaReportGroupByMediaType(String startdate,String endDate) throws Exception {
		...
		for (MediaAccessCensus mediaAccessCensus : mediaAccessCensuss) {
			...
			if (reportDto == null) {
				...
				reportDto.setDate(DateUtils.format(mediaAccessCensus.getDate(), "yyyy-MM-dd"));
